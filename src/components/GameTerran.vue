    ...
    window.addEventListener('keydown', event => {
      ...
      switch (event.keyCode) {
        ...
        case 37:
          ...
          break
        case 13:
          if (terran[hero.x][hero.y] === ' ') return
          this.$store.dispatch('pickupItem')
          break
      }
